 ...
 * Contributor(s):   -;
 *
 * $Id: TextLine.java,v 1.8 2004/03/22 11:02:45 mungady Exp $
 *
 * Changes
 * -------
...
public class TextLine implements Serializable {
    ...
    public void draw(Graphics2D g2, 
        ...
        while (iterator.hasNext()) {
            ...
            Dimension2D d = fragment.calculateDimensions(g2);
            fragment.draw(
    ...
    public Dimension2D calculateDimensions(Graphics2D g2) {
        ...
        while (iterator.hasNext()) {
            TextFragment fragment = (TextFragment) iterator.next();
            Dimension2D dimension = fragment.calculateDimensions(g2);
