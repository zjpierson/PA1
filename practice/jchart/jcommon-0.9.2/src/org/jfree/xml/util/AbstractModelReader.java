 ...
 *
 * $Id: AbstractModelReader.java,v 1.13 2004/03/05 10:59:26 mungady Exp $
 *
 * Changes
 * -------
...
public abstract class AbstractModelReader {
    ...
    private class SAXModelHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName,
            ...
            try {
                ...
                if (getState() == STATE_START) {
                    ...
                    String name = attributes.getValue(ClassModelTags.NAME_ATTR);
                    String target = attributes.getValue(ClassModelTags.CLASS_ATTR);
                    ...
                    String parameterClass = attributes.getValue(ClassModelTags.CLASS_ATTR);
                    String tagName = attributes.getValue(ClassModelTags.PROPERTY_ATTR); // optional
         ...
         *        handling this tag
         */
        private void startObjectElement(String qName, Attributes attributes)
            ...
            if (qName.equals(ClassModelTags.CONSTRUCTOR_TAG)) {
                ...
                String name = attributes.getValue(ClassModelTags.NAME_ATTR);
                String lookupKey = attributes.getValue(ClassModelTags.LOOKUP_ATTR);
                ...
                String elementAtt = attributes.getValue(ClassModelTags.ELEMENT_ATTR);
                String name = attributes.getValue(ClassModelTags.NAME_ATTR);
                handleElementDefinition(name, elementAtt);
            }
            else if (qName.equals(ClassModelTags.ATTRIBUTE_PROPERTY_TAG)) {
                String name = attributes.getValue(ClassModelTags.NAME_ATTR);
                String attribName = attributes.getValue(ClassModelTags.ATTRIBUTE_ATTR);
                String handler = attributes.getValue(ClassModelTags.ATTRIBUTE_HANDLER_ATTR);
         ...
         *        error occured.
         */
        private void startRootElement(String qName, Attributes attributes)
            ...
            if (qName.equals(ClassModelTags.INCLUDE_TAG)) {
                ...
                String src = attributes.getValue(ClassModelTags.SOURCE_ATTR);
                try {
                ...
                setState(IN_OBJECT);
                String className = attributes.getValue(ClassModelTags.CLASS_ATTR);
                String register = attributes.getValue(ClassModelTags.REGISTER_NAMES_ATTR);
                if (register != null && register.length() == 0) {
                    register = null;
                }
                boolean ignored = "true".equals(attributes.getValue(ClassModelTags.IGNORE_ATTR));
                ...
                String className = attributes.getValue(ClassModelTags.CLASS_ATTR);
                String readHandler = attributes.getValue(ClassModelTags.READ_HANDLER_ATTR);
                String writeHandler = attributes.getValue(ClassModelTags.WRITE_HANDLER_ATTR);
                handleManualMapping(className, readHandler, writeHandler);
            }
            else if (qName.equals(ClassModelTags.MAPPING_TAG)) {
                setState(MAPPING_STATE);
                String typeAttr = attributes.getValue(ClassModelTags.TYPE_ATTR);
                String baseClass = attributes.getValue(ClassModelTags.BASE_CLASS_ATTR);
