 ...
 * Contributor(s):   -;
 *
 * $Id: SerialDateTests.java,v 1.7 2004/03/24 23:20:22 mungady Exp $
 *
 * Changes
 * -------
...
public class SerialDateTests extends TestCase {
    ...
    /**
     * Problem the conversion of a string to a weekday.  Note that this test will fail if the 
    ...
    /**
     * Problem the conversion of a string to a month.  Note that this test will fail if the default
