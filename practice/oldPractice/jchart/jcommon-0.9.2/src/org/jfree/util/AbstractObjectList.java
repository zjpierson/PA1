 ...
 *                   Nicolas Brodu
 *
 * $Id: AbstractObjectList.java,v 1.12 2004/03/24 23:20:22 mungady Exp $
 *
 * Changes
 * -------
...
public class AbstractObjectList implements Cloneable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof AbstractObjectList) == false) {
            return false;
        }
        ...
        for (int i = 0; i < size; i++) {
           if (ObjectUtils.equal(get(i), other.get(i)) == false) {
               return false;
           }
        }
        return true;
