 ...
 * Contributor(s):   -;
 *
 * $Id: FormatLayout.java,v 1.6 2004/03/24 23:20:21 mungady Exp $
 *
...
public class FormatLayout implements LayoutManager, Serializable {
        ...
        synchronized (parent.getTreeLock()) {
            ...
            for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
                ...
                switch (format) {
                    case FormatLayout.C:
                        c0 = parent.getComponent(componentIndex);
                        this.columns0to5Width = Math.max(this.columns0to5Width,
    ...
    public void layoutContainer(Container parent) {
        ...
        synchronized (parent.getTreeLock()) {
            ...
            int w1to4 = w1to2 + this.columnGaps[2] + this.columnWidths[3]
            ...
            for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
                ...
                case FormatLayout.LC:
                    ...
                    c0.setBounds(
                        rowX[0],
                        rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2,
                        this.columnWidths[0], c0.getPreferredSize().height
                    );
                    c1 = parent.getComponent(componentIndex + 1);
                    c1.setBounds(
                        rowX[1],
                        rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2,
                ...
                case FormatLayout.LCB:
                    ...
                    c2.setBounds(
                        rowX[5],
                        rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2,
                ...
                case FormatLayout.LCLC:
                    ...
                    c3.setBounds(
                        rowX[4],
                        rowY + (this.rowHeights[rowIndex] - c3.getPreferredSize().height) / 2,
                ...
                case FormatLayout.LCBLC:
                    ...
                    c4.setBounds(
                        rowX[4],
                        rowY + (this.rowHeights[rowIndex] - c4.getPreferredSize().height) / 2,
                ...
                case FormatLayout.LCBLCB:
                    ...
                    c5.setBounds(
                        rowX[5],
                        rowY + (this.rowHeights[rowIndex] - c5.getPreferredSize().height) / 2,
    ...
    public void complete() {
        ...
        this.columnWidths[1] = Math.max(this.columnWidths[1],
                this.columns1and2Width - this.columnGaps[1] - this.columnWidths[2]);

        this.columnWidths[4] = Math.max(
            this.columnWidths[4],
            Math.max(
                this.columns4and5Width - this.columnGaps[4] - this.columnWidths[5],
                Math.max(
                    this.columns1to4Width - this.columnGaps[1] - this.columnGaps[2] 
                        - this.columnGaps[3] - this.columnWidths[1] - this.columnWidths[2] 
                        - this.columnWidths[3],
                    this.columns1to5Width - this.columnGaps[1] - this.columnGaps[2] 
                        - this.columnGaps[3] - this.columnWidths[1] - this.columnWidths[2] 
        ...
        int leftWidth = this.columnWidths[0] + this.columnGaps[0]
                      + this.columnWidths[1] + this.columnGaps[1] + this.columnWidths[2];

        int rightWidth = this.columnWidths[3] + this.columnGaps[3]
                       + this.columnWidths[4] + this.columnGaps[4] + this.columnWidths[5];
