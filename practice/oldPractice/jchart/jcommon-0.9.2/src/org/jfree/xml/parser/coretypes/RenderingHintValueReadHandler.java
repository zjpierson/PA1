 ...
 *
 * $Id: RenderingHintValueReadHandler.java,v 1.5 2004/03/05 13:46:07 mungady Exp $
 *
 * Changes 
 * -------
...
public class RenderingHintValueReadHandler extends AbstractXmlReadHandler {
    ...
    protected void startParsing(Attributes attrs) throws SAXException {
        String keyText = attrs.getValue("key");
        String valueText = attrs.getValue("value");
        this.key = stringToHintField(keyText);
        this.value = stringToHintField(valueText);
    }

    private Object stringToHintField (String name) {
