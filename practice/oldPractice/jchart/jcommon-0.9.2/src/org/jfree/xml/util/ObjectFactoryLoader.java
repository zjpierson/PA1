 ...
 * ------------------------
 * (C) Copyright 2002-2004, by Thomas Morgner and Contributors.
 *
 * Original Author:  Thomas Morgner;
 * Contributor(s):   -;
 *
 * $Id: ObjectFactoryLoader.java,v 1.12 2004/03/24 23:20:23 mungady Exp $
 *
 * Changes
 * -------
...
public class ObjectFactoryLoader extends AbstractModelReader implements ObjectFactory {
    ...
    private void performSuperClassUpdate(GenericObjectFactory gef) {
        ...
        if (superClass != null && !superClass.equals(Object.class)) {
            GenericObjectFactory superGef = (GenericObjectFactory) this.objectMappings.get(
                superClass
            );
            if (superGef != null) {
    ...
    protected void endMultiplexMapping() throws ObjectDescriptionException {
        ...
        Class c = loadClass(this.baseClass);
