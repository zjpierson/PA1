...
//------------------------ Temperature LineChart --------------------------//        
        ...
        JFreeChart chartData = ChartFactory.createLineChart( "Temperature", "CategoryAxisLable", "ValueAxisLable", dataReader.WeatherData.getTemperatureData(), PlotOrientation.VERTICAL, true, true, false);
